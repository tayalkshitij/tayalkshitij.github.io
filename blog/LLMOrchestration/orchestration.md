...
|---|---|---|---|---|
| Chain-of-Thought | Linear chain | Intermediate reasoning steps | 2022 | Wei et al.[^1] |
| ReAct | Loop (reason-act cycle) | External tool interaction | 2022 | Yao et al.[^2] |
| Self Consistency | fan-out then aggregate | Majority voting | 2022 | Wang et al.[^7] |
| Tree of Thoughts | Tree with backtracking | Multi-path exploration + self-evaluation | 2023 | Yao et al.[^4] |
| Graph of Thoughts | Arbitrary directed graph | Thought aggregation, refinement, distillation | 2023 | Besta et al.[^5] |
| Reflexion | Loop with memory | Verbal self-reflection across trials | 2023 | Shinn et al.[^6] |
